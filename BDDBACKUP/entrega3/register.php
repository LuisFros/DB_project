    ...
    if(empty(trim($_POST["username"]))){
        ...
        //    mysqli_stmt_bind_param($stmt, "s", $param_username);
            ...
            $row1 = $searchresult1->fetch();
              ...
              if (!is_bool($row) or !is_bool($row1)){
