      ...
      <div class="row" style="margin: 0px 5px;">
        <?php
          ...
          $fecha = $_POST["fecha_consulta"];
         	...
         	$query = "SELECT Remitentes.nombre, Remitentes.apellido, Destinatarios.nombre, Destinatarios.apellido, cantidad, mensaje FROM Transaccion, Usuario AS Remitentes, Usuario AS Destinatarios WHERE Remitentes.uid = Transaccion.from_id AND Destinatarios.uid = Transaccion.to_id AND fecha::date = '$fecha' AND from_id = $uid;";
